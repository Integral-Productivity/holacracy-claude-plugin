...
4. **Hand off to the skills for the meeting itself.** `holacracy-facilitator` carries the IDM process -- agenda building, the six IDM phases, objection testing, and integration (`skills/holacracy-facilitator/references/governance-meeting.md`). `holacracy-secretary` carries governance capture -- the "Governance Meetings" capture process and the Governance Meeting output template (`skills/holacracy-secretary/references/meeting-templates.md`). Do not duplicate that content here -- hand off, as `tactical.md` does.
